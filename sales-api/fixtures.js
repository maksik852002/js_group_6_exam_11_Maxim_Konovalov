...
const run = async () => {
  ...
  await Product.create({
    ...
    category: computers,
    user: test,
    description: "Продам процессор, хотела апгрейдить компьютер, но купила ноутбук",
    ...
    category: clothes,
    user: test,
    description: "Продам новое пальто размер 56, заказывала из европы, не подошло по размеру",
